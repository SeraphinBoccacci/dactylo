...
/***/ "./containers/dactylo/index.tsx":
false,

/***/ "./containers/dactylo/style.ts":
false,
...
})(["position:fixed;background:#eee;top:0;left:0;width:100vw;height:100vh;"]);
...
})(["position:relative;width:400px;height:40px;line-height:40px;left:calc(50% - 200px);margin-top:5rem;text-align:center;font-family:\"Varela Round\",sans-serif;font-size:2.5rem;color:#ababab;"]);
...
var DactyloInput = Object(styled_components__WEBPACK_IMPORTED_MODULE_0__["default"])(antd__WEBPACK_IMPORTED_MODULE_1__["Input"]).withConfig({
  displayName: "style__DactyloInput",
  componentId: "todod4-4"
})(["position:relative;width:180px;height:40px;left:calc(50% - 100px);margin-top:200px;border:1px #334455 solid;border-radius:5px;background:#887799;outline:none;font-family:\"Abel\";font-size:1.5rem;text-align:center;"]);
...
var DactyloLetter = styled_components__WEBPACK_IMPORTED_MODULE_0__["default"].span.withConfig({
  ...
  return props.status === "OK" ? "green" : props.status === "WRONG" ? "red" : "none";
});
...
})(["margin-top:6rem;font-size:1.5rem;font-family:\"Abel\";width:400px;margin-left:calc(50% - 200px);text-align:center;color:#988776;"]);
...
/* harmony import */ var _containers_train__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../containers/train */ "./containers/train/index.tsx");
var _this = undefined,
    _jsxFileName = "/Users/seraphin/Documents/SBoccacci/Dev/dactylo/pages/dactylo.tsx";
...
var Index = function Index() {
  return __jsx(_containers_train__WEBPACK_IMPORTED_MODULE_1__["default"], {
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 4,
...
//# sourceMappingURL=dactylo.js.7f613da8b6660942493e.hot-update.js.map